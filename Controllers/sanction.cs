...
{
    public class sanction : Controller
    {
        ...
        public IActionResult write_xls(List<Models.Sanction> list_to_write)
        {
            ...
            using (var workbook = new XLWorkbook())
            {
                ...
                worksheet.Cell(currentRow, 14).Value = "مدت پاسخ دهی";
                worksheet.Cell(currentRow, 15).Value = "تاریخ ارجاع به بارزسی";
                worksheet.Cell(currentRow, 16).Value = "توضیحات";
                ...
                foreach (var item in list_to_write)
                {
                    ...
                    worksheet.Cell(currentRow, 14).Value = item.send_until_awnser;
                    worksheet.Cell(currentRow, 15).Value = item.date_send_to_H_B;
                    worksheet.Cell(currentRow, 16).Value = item.xplain;
        ...
        public List<Models.Sanction> search_letter(string y, int m1, int m2, string letter_type = "خاتمه", string search_date = "awnser", string mo = "all")
        {
            //solar date
            ...
            if (m1 == 50 || m2 == 50)
            {
                ...
                if (search_date == "awnser")
                {
                    if (mo != "all")
                    {
                        if (letter_type == "all")
                        {
                            list_letter = context.sanction.Find(x => x.date_awnser.Contains(date_today) && x.place == mo).ToList();
                        }
                        else
                        {
                            list_letter = context.sanction.Find(x => x.letter_status == letter_type && x.date_awnser.Contains(date_today) && x.place == mo).ToList();
                        }
                    }
                    else
                    {
                        if (letter_type == "all")
                        {
                            list_letter = context.sanction.Find(x => x.date_awnser.Contains(date_today)).ToList();
                        }
                        else
                        {
                            list_letter = context.sanction.Find(x => x.letter_status == letter_type && x.date_awnser.Contains(date_today)).ToList();
                        }
                ...
                else
                {
                    ...
                    if (mo != "all")
                    {
                        if (letter_type == "all")
                        {
                            list_letter = context.sanction.Find(x => x.date_send.Contains(date_today) && x.place == mo).ToList();
                        }
                        else
                        {
                            list_letter = context.sanction.Find(x => x.letter_status == letter_type && x.date_send.Contains(date_today) && x.place == mo).ToList();
                        }
                    }
                    else
                    {
                        if (letter_type == "all")
                        {
                            list_letter = context.sanction.Find(x => x.date_send.Contains(date_today)).ToList();
                        }
                        else
                        {
                            list_letter = context.sanction.Find(x => x.letter_status == letter_type && x.date_send.Contains(date_today)).ToList();
                        }
                ...
                if (search_date == "awnser")
                {
                    if (mo != "all")
                    {
                        if (letter_type == "all")
                        {
                            for (int i = m1; i <= m2; i++)
                            {
                                ...
                                list_letter = list_letter.Concat(context.sanction.Find(x => x.date_awnser.Contains(date_today) && x.place == mo).ToList()).ToList();
                            }
                        }
                        else
                        {
                            ...
                            {
                                date_today = moon_len(i, y);
                                list_letter = list_letter.Concat(context.sanction.Find(x => x.letter_status == letter_type && x.date_awnser.Contains(date_today) && x.place == mo).ToList()).ToList();
                            }
                        }
                    }
                    else
                    {
                        if (letter_type == "all")
                        {
                            ...
                            {
                                date_today = moon_len(i, y);
                                list_letter = list_letter.Concat(context.sanction.Find(x => x.date_awnser.Contains(date_today)).ToList()).ToList();
                        ...
                        else
                        {
                            ...
                            {
                                date_today = moon_len(i, y);
                                list_letter = list_letter.Concat(context.sanction.Find(x => x.letter_status == letter_type && x.date_awnser.Contains(date_today)).ToList()).ToList();
                            }
                        }
                ...
                else
                {
                    ...
                    if (mo != "all")
                    {
                        if (letter_type == "all")
                        {
                            ...
                            {
                                date_today = moon_len(i, y);
                                list_letter = list_letter.Concat(context.sanction.Find(x => x.date_send.Contains(date_today) && x.place == mo).ToList()).ToList();
                            }
                        }
                        else
                        {
                            ...
                            {
                                date_today = moon_len(i, y);
                                list_letter = list_letter.Concat(context.sanction.Find(x => x.letter_status == letter_type && x.date_send.Contains(date_today) && x.place == mo).ToList()).ToList();
                            }
                        }
                    }
                    else
                    {
                        if (letter_type == "all")
                        {
                            ...
                            {
                                date_today = moon_len(i, y);
                                list_letter = list_letter.Concat(context.sanction.Find(x => x.date_send.Contains(date_today)).ToList()).ToList();
                            }
                        }
                        else
                        {
                            ...
                            {
                                date_today = moon_len(i, y);
                                list_letter = list_letter.Concat(context.sanction.Find(x => x.letter_status == letter_type && x.date_send.Contains(date_today)).ToList()).ToList();
                            }
                        }
        ...
        public IActionResult Index(int follow_page = 1)
        {
            ...
            log.subject = "sanction";
            log.obj = "اتمام مهلت";
            context.Log.InsertOne(log);
            //
            List<Models.Sanction> list_letter = context.sanction.Find(x => x.letter_status == "اتمام مهلت" || x.letter_status == "فوری" || x.letter_status == "بررسی پاسخ").ToList();
            ...
            ViewBag.now_page = follow_page;
            list_letter = context.sanction.Find(x => x.letter_status == "اتمام مهلت" || x.letter_status == "فوری" || x.letter_status == "بررسی پاسخ").Skip((follow_page - 1) * 30).Limit(30).ToList();
        ...
        public IActionResult Index_end(int year = 0, int month = 0,string letter_type= "خاتمه")
        {
            ...
            //    }
            //}
            List<Models.Sanction> list_letter = context.sanction.Find(x => x.letter_status == "خاتمه" && x.date_awnser.Contains(date_today)).ToList();
        ...
        public IActionResult Index_end(string y,int m1, int m2, int follow_page=1, string letter_type = "خاتمه",string search_date= "awnser",string mo="all",string let_num="0",string type_num= "serial")
        {
            ...
            else
            {
                ...
                {
                    case "serial":
                        list_letter = context.sanction.Find(x => x.serial == let_num).ToList();
                        break;
                    case "meetingـnumber":
                        list_letter = context.sanction.Find(x => x.meetingـnumber == let_num).ToList();
                        break;
                }
        ...
        public IActionResult Index_send_H_B(int follow_page = 1)
        {
            ...
            List<Models.Sanction> list_letter = context.sanction.Find(x => x.letter_status == "ارسال به بازرسی").ToList();
            int count_val = list_letter.Count();
            int count_page = count_val / 30;
            ViewBag.count_page = count_page + 1;
            if (follow_page == -5)
            ...
            ViewBag.now_page = follow_page;
            list_letter = context.sanction.Find(x => x.letter_status == "ارسال به بازرسی").Skip((follow_page - 1) * 30).Limit(30).ToList();
            return View(list_letter);
        }
        public IActionResult Index_in_progres(int follow_page = 1)
        {
            ...
            context.Log.InsertOne(log);
            //
            List<Models.Sanction> list_letter = context.sanction.Find(x => x.letter_status == "در حال پیگیری").ToList();
            int count_val = list_letter.Count();
            int count_page = count_val / 30;
            ViewBag.count_page = count_page + 1;
            if (follow_page == -5)
            ...
            ViewBag.now_page = follow_page;
            list_letter = context.sanction.Find(x => x.letter_status == "در حال پیگیری").Skip((follow_page - 1) * 30).Limit(30).ToList();
            return View(list_letter);
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,serial,title,meetingـnumber,date_create,date_send,place,day_reserve,count_followed,last_day_reserve,letter_status,awnser_serial,date_awnser,date_send_to_H_B,xplain")] Models.Sanction letter)
        {
            int C = Chek_cooke();
            if (C != 1)
            {
            ...
            if (list_let.Count() == 0)
            {
                ...
                context.Log.InsertOne(log);
                //
                context.sanction.InsertOne(letter);
                ViewBag.status = "ok";
            }
            else
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Id,serial,title,meetingـnumber,date_create,date_send,place,day_reserve,count_followed,last_day_reserve,letter_status,awnser_serial,date_awnser,date_send_to_H_B,xplain")] Models.Sanction letter)
        {
            try
            {
                int C = Chek_cooke();
                ...
                context.sanction.DeleteMany(a => a.Id == id);
                context.sanction.InsertOne(letter);
                //log
                //Models.Log log = new Models.Log();
                ...
                //context.Log.InsertOne(log);
                //
                return Redirect("~/sanction/Index");
            }
            catch (Exception e)
            {
                return BadRequest(e.Message);
        ...
        public IActionResult Delete(string id)
        {
            ...
            List<Models.Sanction> letters = context.sanction.Find(x => x.Id == id).ToList();
            context.deleted_sanction.InsertMany(letters);
            Models.Sanction lett = letters[0];
            //log
            Models.Log log = new Models.Log();
            log.user = get_username();
        ...
        public IActionResult continuation(string id, string day, string date_fllowed)
        {
            ...
            List<Models.Sanction> let_lis = context.sanction.Find(x => x.Id == id).ToList();
            Models.Sanction let = let_lis[0];
            ...
            //
            context.sanction.DeleteMany(x => x.Id == id);
            context.sanction.InsertOne(let);
        ...
        public IActionResult export(string type,string y,string moon, int m2=0, string letter_type = "خاتمه", string search_date = "awnser", string mo = "all")
        {
            ...
            switch (type)
            {
                case "end_moon":
                    ...
                    break;
                case "end_time":
                    list_letter = context.sanction.Find(x => x.letter_status == "اتمام مهلت" || x.letter_status == "فوری").ToList();
                    break;
                case "end":
                    list_letter = context.sanction.Find(x => x.letter_status == "خاتمه").ToList();
                    break;
                case "in_progress":
                    list_letter = context.sanction.Find(x => x.letter_status == "در حال پیگیری").ToList();
                    break;
                case "send_H_B":
                    list_letter = context.sanction.Find(x => x.letter_status == "ارسال به بازرسی").ToList();
                    break;
                default:
                    list_letter = context.sanction.Find(x => true).ToList();
                    break;
            }
        ...
        public IActionResult xplain(string xplain, string id)
        {
            ...
            List<Models.Sanction> le = context.sanction.Find(x => x.Id == id).ToList();
            Models.Sanction letter = le[0];
            ...
            context.Log.InsertOne(log);
            //
            context.sanction.DeleteOne(x => x.Id == id);
            context.sanction.InsertOne(letter);
